...
def Deploy_8(request): 
    ...
    if request.method == "POST":
        ...
        models = keras.models.load_model('D:/DL10/DL10/ITPDL11(Done)/Deploy/Project/App/keras_model.h5')
        data = np.ndarray(shape=(1, 224, 224, 3), dtype=np.float32)
        image = Image.open("D:/DL10/DL10/ITPDL11(Done)/Deploy/Project/" + str(result1)).convert("RGB")
        size = (224, 224)
